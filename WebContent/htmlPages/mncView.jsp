...
<body>
	<%
		...
		sql="select i.iid,i.title,i.description,i.rating,i.feedback,i.reviewer,i.username,u.emailid from ideadetails i,userdetails u where i.department=? and i.rated=? and i.username=u.username";
